...
Navigate with ↑↓ arrows, Enter to confirm, Esc to go back, Ctrl+C to quit. The live ASCII preview updates as you pick colors. Output goes to `~/Downloads/qrcode.png` by default — no extra prompts.
